            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        <!-- form start -->
                        <form class="form-horizontal form-submit-event" action="#" url="<?= base_url('seller/customer/add_customer'); ?>" method="POST" id="add_product_form">
                            <input type="hidden" class="form-control" name="by_seller_id" value="<?= $by_seller_id ?>">
                            <input type="hidden" class="form-control" name="by_seller_name" value="<?= $by_seller_name ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-success" id="submit_btn">Add Customer</button>
                                </div>
                            </div>
