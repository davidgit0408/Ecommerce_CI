            ...
            <div class="card h-100">
                ...
                <div class="card-body row">
                    ...
                    <div class="d-flex gap-3 col-4">
                        ...
                        <div class="card-info">
                            <h4 class="mb-0"><?= $status_counts['delivered'] ?></h4>
                ...
                <div class="card-body">
                    <div class="d-flex gap-3 p-2">
                        <div class="card-info">
                            ...
                            <a
                                    class="text-success"
                                    href="<?= base_url('seller/product/?flag=sold') ?>"  class="text-decoration-none small-box-footer">
                                More info
                    ...
                    <div class="d-flex gap-3 p-2">
                        <div class="card-info">
                            ...
                            <a class="text-success"
                               href="<?= base_url('seller/product/?flag=low') ?>" class="text-decoration-none small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
            ...
            <div class="modal-content p-3 p-md-5">
                ...
                <div class="modal-body">
                    <div class="tab-pane " role="tabpanel" aria-labelledby="product-rating-tab">
                        ...
                        <table class='table-striped' id="order_tracking_table" data-toggle="table" data-url="<?= base_url('seller/orders/get-order-tracking') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-query-params="order_tracking_query_params">
                            <thead>
                            <tr>
