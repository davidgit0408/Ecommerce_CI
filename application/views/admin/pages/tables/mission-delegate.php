<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h4>Mission Delegate</h4>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Home</a></li>
                        <li class="breadcrumb-item active">Mission Delegate</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="card content-area p-4">
                    <div class="card-header border-0">
                        <div class="card-tools">
                            <a href="<?= base_url() . 'admin/delegate/create_mission' ?>" class="btn btn-block btn-outline-primary btn-sm">Add Mission</a>
                        </div>
                    </div>
                    <div class="card-innr">
                        <div class="gaps-1-5x"></div>
                        <table class='table-striped' id='products_table' data-toggle="table" data-url="<?= base_url('admin/delegate/get_delegate_data') ?>" data-click-to-select="true" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-columns="true" data-show-refresh="true" data-trim-on-search="false" data-sort-name="id" data-sort-order="desc" data-mobile-responsive="true" data-toolbar="" data-show-export="true" data-maintain-selected="true" data-export-types='["txt","excel","csv"]' data-export-options='{
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="delegate_name" data-sortable="false" data-align='center'>Delegate Name</th>
                                    <th data-field="customer_name" data-sortable="false" data-align='center'>Customer Name</th>
                                    <th data-field="visiting_days" data-sortable="true" data-align='center'>Visiting Days</th>
